...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/mahler_kindertotenlieder.git
...
* `Gustav Mahler – Kindertotenlieder <https://github.com/DCMLab/mahler_kindertotenlieder/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by four files with identical names, each in its own folder. For example, the first song, *Nun will die Sonn’ so hell aufgeh’n!* has the following files:

-  ``MS3/kindertotenlieder_01_nun_will_die_sonn.mscx``: Uncompressed MuseScore file including the music and annotation labels.
-  ``notes/kindertotenlieder_01_nun_will_die_sonn.tsv``: A table of all note heads contained in the score and their relevant features (not each of them represents an onset, some are tied together)
-  ``measures/kindertotenlieder_01_nun_will_die_sonn.tsv``: A table with relevant information about the measures in the score.
-  ``harmonies/kindertotenlieder_01_nun_will_die_sonn.tsv``: A list of the included harmony labels (including cadences and phrases) with their positions in the score.
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/kindertotenlieder_01_nun_will_die_sonn.tsv')
   notes = ms3.load_tsv('notes/kindertotenlieder_01_nun_will_die_sonn.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/mahler_kindertotenlieder/issues>`__ and feel free to fork and submit pull requests.
